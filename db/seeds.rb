...
User.create(username:'admin', email:'ptonyptc@gmail.com', password:'1234', password_confirmation:'1234', status:1 )
User.create(username:'anthony', email:'ptonyp19@hotmail.com', password:'1234', password_confirmation:'1234', status:2 )
