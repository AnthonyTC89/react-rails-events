...
admin.save
super_user = User.new(username: 'superuser', email: 'superuser@gmail.com', password: 'superuser', password_confirmation: 'superuser', status: 2)
super_user.save
...
Event.create(title: 'Event 3 Title', description: lorem, date: Date.today + 1, time: Time.now, location: 'Lima', status: 1, user_id: super_user.id)
Event.create(title: 'Event 4 Title', description: lorem, date: Date.today + 30, time: Time.now, location: 'Cusco', status: 1, user_id: super_user.id)
